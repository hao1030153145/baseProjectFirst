...
public class MySystemCode extends SystemCode {
    ...
    public static final String DELETE_EXCEPTION_VISPROJECT_ERROR_MESSAGE = "直接删除任务组将清空其中任务，请考虑清楚是否继续？";

    static {
        errorMessageMap.put(DELETE_EXCEPTION_VISPROJECT_ERROR, DELETE_EXCEPTION_VISPROJECT_ERROR_MESSAGE);
    }
}
